...
const AddPostPage = () => {
    ...
    >
        ...
        <label className='text-xs text-white opacity-60'>
            Заголовок поста:
            <input type='text'
                   className='mt-1 text-black w-full rounded-lg bg-gray-400 border px-2 text-xs outline-none placeholder:text-gray-700'
            />
        </label>
        ...
        <label className='text-xs text-white opacity-60'>
            ...
            <textarea placeholder='Текст поста'
                   className='mt-1 text-black w-full rounded-lg bg-gray-400 border px-2 text-xs outline-none resize-none h-40 placeholder:text-gray-700'
            />
        </label>
